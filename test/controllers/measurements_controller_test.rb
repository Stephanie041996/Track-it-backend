...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create measurement' do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { category: @measurement.category } }, as: :json
    end
  ...
  test 'should update measurement' do
    patch measurement_url(@measurement), params: { measurement: { category: @measurement.category } }, as: :json
    assert_response 200
  end
